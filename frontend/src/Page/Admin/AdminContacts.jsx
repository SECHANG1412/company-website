...
const AdminContacts = () => {
  ...
  return (
    <div className="p-4 mx-suto max-w-[1400px]">
              ...
              <tr key={contact._id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-3">
                  <div className="flex justify-center space-x-2">
                    <button className="px-3 py-1.5 bg-blue-500 text-white rounded hover:bg-blue-600flex items-center justify-center whitespace-nowrap writing-normal">
                      수정
                    </button>
